 ...
 */
inline double LeadingLog(double s, double t,
                         double qt,
...
struct ProcessTraits<CQperp_thermal_LL> {
    static constexpr auto dist1 = DistributionCQperp::bose;  // not used in C(q_perp)
    ...
    static constexpr auto dist4 = DistributionCQperp::bose;  // scattered medium particle
...
int main(int argc, char *argv[]) {
    ...
    std::string outputFile = ReadFileName(argc, argv, "OUTPUT/CQperp_thermal_LL.dat");
